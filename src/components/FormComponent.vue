      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <b-form @submit.prevent="onSubmit">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-6" label="Total Gift Card" label-for="input-6">
                  <b-form-input type="time" v-model="selectedGiftCardDownRangeA"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-7" label="Total Gift Card" label-for="input-7">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-8" label="Total Gift Card" label-for="input-8">
                  <b-form-input type="time" v-model="selectedGiftCardDownRangeB"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-9" label="Total Gift Card" label-for="input-9">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-10" label="Total Gift Card" label-for="input-10">
                  <b-form-input type="time" v-model="selectedGiftCardDownRangeC"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-11" label="Total Gift Card" label-for="input-11">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-12" label="Total Gift Card" label-for="input-12">
                  <b-form-input type="time" v-model="selectedGiftCardDownRangeD"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-13" label="Total Gift Card" label-for="input-13">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-14" label="Total Gift Card" label-for="input-14">
                  <b-form-input type="time" v-model="selectedGiftCardDownRangeE"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-15" label="Total Gift Card" label-for="input-15">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-16" label="Total Gift Card" label-for="input-16">
                  <b-form-input type="time" v-model="selectedTopPriceScheduleRangeAUp"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-17" label="Total Gift Card" label-for="input-17">
            ...
            <div class="row mb-4">
              <div class="col">
                <b-form-group id="input-group-18" label="Total Gift Card" label-for="input-18">
                  <b-form-input type="time" v-model="selectedTopPriceScheduleRangeBUp"></b-form-input>
                </b-form-group>
              </div>
              <div class="col">
                <b-form-group id="input-group-19" label="Total Gift Card" label-for="input-19">
